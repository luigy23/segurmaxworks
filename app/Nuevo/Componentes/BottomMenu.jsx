  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
      <div className="flex justify-between items-center h-16 max-w-md mx-auto px-4">
        ...
        <MenuItem icon={<div className=' items-center justify-center text-center flex rounded-full text-4xl bg-smoke-800 pb-2 text-slate-50 h-20 w-20'>
...
const MenuItem = ({ icon, label, isCenter }) => (
  <div className={`flex flex-col items-center ${isCenter ? 'transform translate-y-[-20px]' : ''}`}>
    {icon}
